...
handle_postgresql() {
	...
	echo "COL_MINZOOM: $COL_MINZOOM"
	echo "COL_MAXZOOM: $COL_MAXZOOM"
	if [[ -z "$COL_MINZOOM" ]]; then
		COL_MINZOOM=3
	fi
	if [[ -z "$COL_MAXZOOM" ]]; then
		COL_MAXZOOM=14
	fi
	COL_VALUE_ARRAY=''
	COL_VECTOR_JSON=''
	...
	if [[ "$HAS_LAYER" = "None" ]]; then
		...
		if [[ -z "$START_TIME" && $DATASET_TYPE != "tiff-time" ]]; then
			python3 $MINTCAST_PATH/python/macro_postgres_curd insert layer \
				"layerid, type, tileformat, name, sourceLayer, hasData, hasTimeline, bounds, mbfilename, directory_format, json_filename, server, tileurl, legend_type, legend, valueArray, vector_json, colormap, original_dataset_bounds, mapping, stdname, md5, original_id , minzoom, maxzoom, title, layer_type"\
				"'$COL_LAYER_ID', '$COL_RASTER_OR_VECTOR_TYPE', '$COL_TILE_FORMAT', '$COL_LAYER_NAME', '$COL_SOURCE_LAYER', $COL_HAS_DATA, $COL_HAS_TIMELINE, '$COL_BOUNDS', '$COL_MBTILES_FILENAME', '$COL_DIRECTORY_FORMAT', '$COL_JSON_FILENAME', '$COL_SERVER','$COL_TILE_URL', '$COL_LEGEND_TYPE', '$COL_LEGEND', '$COL_VALUE_ARRAY', '$COL_VECTOR_JSON', '$COL_COLORMAP', '$COL_ORIGINAL_DATASET_BOUNDS', '$COL_MAPPING', '', '$COL_MD5', $COL_ORIGINAL_ID, $COL_MINZOOM, $COL_MAXZOOM, '$COL_LAYER_TITLE', $LAYER_TYPE"
			...
			python3 $MINTCAST_PATH/python/macro_postgres_curd insert layer \
				"layerid, type, tileformat, name, sourceLayer, hasData, hasTimeline, bounds, mbfilename, directory_format, json_filename, server, tileurl, legend_type, legend, valueArray, vector_json, colormap, original_dataset_bounds, mapping, stdname, md5, original_id , minzoom, maxzoom, axis, stepType, stepOption_type, stepOption_format, step, title, layer_type"\
				"'$COL_LAYER_ID', '$COL_RASTER_OR_VECTOR_TYPE', '$COL_TILE_FORMAT', '$COL_LAYER_NAME', '$COL_SOURCE_LAYER', $COL_HAS_DATA, $COL_HAS_TIMELINE, '$COL_BOUNDS', '$COL_MBTILES_FILENAME', '$COL_DIRECTORY_FORMAT', '$COL_JSON_FILENAME', '$COL_SERVER','$COL_TILE_URL', '$COL_LEGEND_TYPE', '$COL_LEGEND', '$COL_VALUE_ARRAY', '$COL_VECTOR_JSON', '$COL_COLORMAP', '$COL_ORIGINAL_DATASET_BOUNDS', '$COL_MAPPING', '', '$COL_MD5', $COL_ORIGINAL_ID, $COL_MINZOOM, $COL_MAXZOOM, '$COL_AXIS', '$COL_STEP_TYPE', '$COL_STEP_OPTION_TYPE', '$COL_STEP_OPTION_FORMAT', '$COL_STEP', '$COL_LAYER_TITLE', $LAYER_TYPE"
		elif [[ ! -z "$START_TIME" ]]; then
			python3 $MINTCAST_PATH/python/macro_postgres_curd insert layer \
				"layerid, type, tileformat, name, sourceLayer, hasData, hasTimeline, mbfilename, directory_format, json_filename, server, tileurl, legend_type, legend, valueArray, vector_json, colormap, original_dataset_bounds, mapping, stdname, md5, original_id, minzoom, maxzoom, bounds, starttime, endtime, axis, stepType, stepOption_type, stepOption_format, step, title, layer_type"\
				"'$COL_LAYER_ID', '$COL_RASTER_OR_VECTOR_TYPE', '$COL_TILE_FORMAT', '$COL_LAYER_NAME', '$COL_SOURCE_LAYER', $COL_HAS_DATA, $COL_HAS_TIMELINE, '$COL_MBTILES_FILENAME', '$COL_DIRECTORY_FORMAT', '$COL_JSON_FILENAME', '$COL_SERVER','$COL_TILE_URL', '$COL_LEGEND_TYPE', '$COL_LEGEND', '$COL_VALUE_ARRAY', '$COL_VECTOR_JSON', '$COL_COLORMAP', '$COL_ORIGINAL_DATASET_BOUNDS', '$COL_MAPPING', '', '$COL_MD5', $COL_ORIGINAL_ID, $COL_MINZOOM, $COL_MAXZOOM, '$COL_BOUNDS', to_date('$COL_START_TIME', '$PSQL_TO_DATE'), to_date('$COL_END_TIME','$PSQL_TO_DATE'), '$COL_AXIS', '$COL_STEP_TYPE', '$COL_STEP_OPTION_TYPE', '$COL_STEP_OPTION_FORMAT', '$COL_STEP','$COL_LAYER_TITLE', $LAYER_TYPE"
